; ModuleID = 'tests/arguments/mode1/withArgsReplacement.bc'
...
@1 =  constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_4004e0_main
@2 =  constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_400564__term_proc
@3 =  constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_400390__init_proc
@4 =  constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_4004c0_replacement
...
block_4004c0:
  ...
  store i64 %17, i64* %4, align 8, !tbaa !1256
  ...
  %45 = load i64, i64* %44
  store i64 %45, i64* %6, align 8, !tbaa !1256
  %46 = inttoptr i64 %8 to i64*
  %47 = load i64, i64* %46
  store i64 %47, i64* %0, align 8, !tbaa !1256
  %48 = add i64 %8, 8
...
; Function Attrs: noinline nounwind
define  %struct.Memory* @sub_400564__term_proc(%struct.State* nocapture dereferenceable(3280) %state2, i64 %pc, %struct.Memory* returned %memory1) #3 {
block_400564:
  %0 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: noinline nounwind
define  %struct.Memory* @sub_4004e0_main(%struct.State* nocapture dereferenceable(3280) %state2, i64 %pc, %struct.Memory* %memory1) #3 {
block_4004e0:
  %0 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 33, i32 0, i32 0
  %1 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 1, i32 0, i32 0
  %2 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 13, i32 0, i32 0
...
define dllexport void @main() local_unnamed_addr #4 {
  tail call void asm sideeffect "pushq $0;pushq $$0x4004e0;jmpq *$1;", "*m,*m,~{dirflag},~{fpsr},~{flags}"(%struct.Memory* (%struct.State*, i64, %struct.Memory*)** nonnull @1, void ()** nonnull @0) #5
  ret void
}

; Function Attrs: naked nobuiltin noinline nounwind
define dllexport void @.term_proc() local_unnamed_addr #4 {
  tail call void asm sideeffect "pushq $0;pushq $$0x400564;jmpq *$1;", "*m,*m,~{dirflag},~{fpsr},~{flags}"(%struct.Memory* (%struct.State*, i64, %struct.Memory*)** nonnull @2, void ()** nonnull @0) #5
  ret void
}

; Function Attrs: naked nobuiltin noinline nounwind
define dllexport void @.init_proc() local_unnamed_addr #4 {
  tail call void asm sideeffect "pushq $0;pushq $$0x400390;jmpq *$1;", "*m,*m,~{dirflag},~{fpsr},~{flags}"(%struct.Memory* (%struct.State*, i64, %struct.Memory*)** nonnull @3, void ()** nonnull @0) #5
  ret void
}

; Function Attrs: naked nobuiltin noinline nounwind
define dllexport void @replacement() local_unnamed_addr #4 {
  tail call void asm sideeffect "pushq $0;pushq $$0x4004c0;jmpq *$1;", "*m,*m,~{dirflag},~{fpsr},~{flags}"(%struct.Memory* (%struct.State*, i64, %struct.Memory*)** nonnull @4, void ()** nonnull @0) #5
  ret void
}
