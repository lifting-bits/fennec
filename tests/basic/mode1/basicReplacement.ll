; ModuleID = 'tests/basic/mode1/basicReplacement.bc'
...
@1 =  constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_4004d0_main
@2 =  constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_400554__term_proc
@3 =  constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_4004c0_replacement
...
define  %struct.Memory* @sub_4004d0_main(%struct.State* nocapture dereferenceable(3280) %state2, i64 %pc, %struct.Memory* %memory1) #3 {
block_4004d0:
...
; Function Attrs: noinline nounwind
define  %struct.Memory* @sub_400554__term_proc(%struct.State* nocapture dereferenceable(3280) %state2, i64 %pc, %struct.Memory* returned %memory1) #3 {
block_400554:
  %0 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 33, i32 0, i32 0
...
block_4004c0:
  ...
  %7 = inttoptr i64 %6 to i64*
  store i64 %4, i64* %7
  store i64 2, i64* %1, align 8, !tbaa !1256
...
define dllexport void @main() local_unnamed_addr #4 {
  tail call void asm sideeffect "pushq $0;pushq $$0x4004d0;jmpq *$1;", "*m,*m,~{dirflag},~{fpsr},~{flags}"(%struct.Memory* (%struct.State*, i64, %struct.Memory*)** nonnull @1, void ()** nonnull @0) #5
  ret void
}

; Function Attrs: naked nobuiltin noinline nounwind
define dllexport void @.term_proc() local_unnamed_addr #4 {
  tail call void asm sideeffect "pushq $0;pushq $$0x400554;jmpq *$1;", "*m,*m,~{dirflag},~{fpsr},~{flags}"(%struct.Memory* (%struct.State*, i64, %struct.Memory*)** nonnull @2, void ()** nonnull @0) #5
  ret void
}

; Function Attrs: naked nobuiltin noinline nounwind
define dllexport void @replacement() local_unnamed_addr #4 {
  tail call void asm sideeffect "pushq $0;pushq $$0x4004c0;jmpq *$1;", "*m,*m,~{dirflag},~{fpsr},~{flags}"(%struct.Memory* (%struct.State*, i64, %struct.Memory*)** nonnull @3, void ()** nonnull @0) #5
  ret void
}
