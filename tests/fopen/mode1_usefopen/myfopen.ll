; ModuleID = 'tests/fopen/mode1_usefopen/myfopen.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu-elf"

%seg_400620__rodata_type = type <{ [4 x i8], [24 x i8] }>
...
@seg_400620__rodata =  constant %seg_400620__rodata_type <{ [4 x i8] c"\01\00\02\00", [24 x i8] c"fopen has been replaced\00" }>
...
@1 =  constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_400595_main
@2 =  constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_400614__term_proc
@3 =  constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_400400__init_proc
@4 =  constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_400566_newfopen
...
define  %struct.Memory* @sub_400614__term_proc(%struct.State* nocapture dereferenceable(3280) %state2, i64 %pc, %struct.Memory* returned %memory1) #3 {
block_400614:
...
; Function Attrs: noinline nounwind
define  fastcc %struct.Memory* @sub_400460___gmon_start__(%struct.State* dereferenceable(3280) %state2, i64 %pc, %struct.Memory* %memory1) unnamed_addr #3 {
block_400460:
  %0 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: noinline nounwind
define  %struct.Memory* @sub_400400__init_proc(%struct.State* dereferenceable(3280) %state2, i64 %pc, %struct.Memory* %memory1) #3 {
block_400400:
  %0 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 33, i32 0, i32 0
  ...
  br i1 %18, label %block_400415, label %block_400410
...
block_400410:                                     ; preds = %block_400400
  ...
  %27 = tail call fastcc %struct.Memory* @sub_400460___gmon_start__(%struct.State* nonnull %state2, i64 %23, %struct.Memory* %memory1)
  %.pre = load i64, i64* %2, align 8
  br label %block_400415

block_400415:                                     ; preds = %block_400410, %block_400400
  %28 = phi i64 [ %4, %block_400400 ], [ %.pre, %block_400410 ]
  %MEMORY.0 = phi %struct.Memory* [ %memory1, %block_400400 ], [ %27, %block_400410 ]
  %29 = add i64 %28, 8
...
; Function Attrs: noinline nounwind
define  %struct.Memory* @sub_400566_newfopen(%struct.State* dereferenceable(3280) %state2, i64 %pc, %struct.Memory* %memory1) #3 {
block_400566:
  %0 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 33, i32 0, i32 0
  %1 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 1, i32 0, i32 0
  ...
  store i8 %20, i8* %21, align 1, !tbaa !1270
  %22 = xor i64 %9, 16
  %23 = xor i64 %22, %11
  %24 = lshr i64 %23, 4
  ...
  store i64 %44, i64* %45
  store i64 and (i64 add (i64 ptrtoint (%seg_400620__rodata_type* @seg_400620__rodata to i64), i64 4), i64 4294967295), i64* %4, align 8, !tbaa !1275
  %46 = add i64 %pc, -310
  %47 = add i64 %pc, 26
  %48 = add i64 %8, -32
  ...
  store i64 %46, i64* %0, align 8, !tbaa !1275
  %50 = tail call fastcc %struct.Memory* @ext_400430_puts(%struct.State* nonnull %state2, %struct.Memory* %memory1) #6
  %51 = load i64, i64* %6, align 8
  %52 = add i64 %51, -16
  %53 = load i64, i64* %0, align 8
  %54 = inttoptr i64 %52 to i64*
  %55 = load i64, i64* %54
  store i64 %55, i64* %2, align 8, !tbaa !1275
  %56 = add i64 %51, -8
  %57 = inttoptr i64 %56 to i64*
  %58 = load i64, i64* %57
  store i64 %58, i64* %1, align 8, !tbaa !1275
  store i64 %55, i64* %3, align 8, !tbaa !1275
  store i64 %58, i64* %4, align 8, !tbaa !1275
  %59 = add i64 %53, -304
  %60 = add i64 %53, 19
  %61 = load i64, i64* %5, align 8, !tbaa !1275
  %62 = add i64 %61, -8
  %63 = inttoptr i64 %62 to i64*
  store i64 %60, i64* %63
  store i64 %62, i64* %5, align 8, !tbaa !1275
  store i64 %59, i64* %0, align 8, !tbaa !1275
  %64 = tail call fastcc %struct.Memory* @ext_601058_fopen(%struct.State* nonnull %state2, %struct.Memory* %50) #6
  %65 = load i64, i64* %6, align 8, !tbaa !1275
  %66 = inttoptr i64 %65 to i64*
  %67 = load i64, i64* %66
  store i64 %67, i64* %6, align 8, !tbaa !1275
  %68 = add i64 %65, 8
  %69 = inttoptr i64 %68 to i64*
  %70 = load i64, i64* %69
  store i64 %70, i64* %0, align 8, !tbaa !1275
  %71 = add i64 %65, 16
  store i64 %71, i64* %5, align 8, !tbaa !1275
  ret %struct.Memory* %64
}

; Function Attrs: noinline nounwind
define  %struct.Memory* @sub_400595_main(%struct.State* nocapture dereferenceable(3280) %state2, i64 %pc, %struct.Memory* %memory1) #3 {
block_400595:
  %0 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 33, i32 0, i32 0
  %1 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 1, i32 0, i32 0
  %2 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 13, i32 0, i32 0
  ...
  %9 = load i64, i64* %8
  store i64 %9, i64* %3, align 8, !tbaa !1275
  %10 = inttoptr i64 %5 to i64*
  %11 = load i64, i64* %10
  store i64 %11, i64* %0, align 8, !tbaa !1275
  %12 = add i64 %5, 8
  store i64 %12, i64* %2, align 8, !tbaa !1275
  ret %struct.Memory* %memory1
}
...
define dllexport void @main() local_unnamed_addr #4 {
  tail call void asm sideeffect "pushq $0;pushq $$0x400595;jmpq *$1;", "*m,*m,~{dirflag},~{fpsr},~{flags}"(%struct.Memory* (%struct.State*, i64, %struct.Memory*)** nonnull @1, void ()** nonnull @0) #6
  ret void
}

; Function Attrs: noinline nounwind
define  fastcc %struct.Memory* @ext_400430_puts(%struct.State*, %struct.Memory*) unnamed_addr #5 {
  %3 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @puts to i64), %struct.Memory* %1)
  ret %struct.Memory* %3
}

; Function Attrs: noinline nounwind
define  fastcc %struct.Memory* @ext_601058_fopen(%struct.State*, %struct.Memory*) unnamed_addr #5 {
...
define dllexport void @.term_proc() local_unnamed_addr #4 {
  tail call void asm sideeffect "pushq $0;pushq $$0x400614;jmpq *$1;", "*m,*m,~{dirflag},~{fpsr},~{flags}"(%struct.Memory* (%struct.State*, i64, %struct.Memory*)** nonnull @2, void ()** nonnull @0) #6
  ret void
}

; Function Attrs: naked nobuiltin noinline nounwind
define dllexport void @.init_proc() local_unnamed_addr #4 {
  tail call void asm sideeffect "pushq $0;pushq $$0x400400;jmpq *$1;", "*m,*m,~{dirflag},~{fpsr},~{flags}"(%struct.Memory* (%struct.State*, i64, %struct.Memory*)** nonnull @3, void ()** nonnull @0) #6
  ret void
}

; Function Attrs: naked nobuiltin noinline nounwind
define dllexport void @newfopen() local_unnamed_addr #4 {
  tail call void asm sideeffect "pushq $0;pushq $$0x400566;jmpq *$1;", "*m,*m,~{dirflag},~{fpsr},~{flags}"(%struct.Memory* (%struct.State*, i64, %struct.Memory*)** nonnull @4, void ()** nonnull @0) #6
  ret void
}
