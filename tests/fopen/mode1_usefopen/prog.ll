; ModuleID = 'tests/fopen/mode1_usefopen/prog.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-pc-linux-gnu-elf"

%seg_400640__rodata_type = type <{ [8 x i8], [32 x i8], [2 x i8], [21 x i8], [22 x i8], [18 x i8] }>
...
@seg_400640__rodata = internal constant %seg_400640__rodata_type <{ [8 x i8] c"\01\00\02\00\00\00\00\00", [32 x i8] c"Calling the fopen() function...\00", [2 x i8] c"r\00", [21 x i8] c"tests/fopen/test.txt\00", [22 x i8] c"fopen() returned NULL\00", [18 x i8] c"fopen() succeeded\00" }>
...
@1 = internal constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_400566_main
@2 = internal constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_400634__term_proc
@3 = internal constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_400400__init_proc
...
define internal %struct.Memory* @sub_400400__init_proc(%struct.State* dereferenceable(3280) %state2, i64 %pc, %struct.Memory* %memory1) #3 {
block_400400:
...
; Function Attrs: noinline nounwind
define internal %struct.Memory* @sub_400566_main(%struct.State* dereferenceable(3280) %state2, i64 %pc, %struct.Memory* %memory1) #3 {
block_400566:
  %0 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 33, i32 0, i32 0
  %1 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 1, i32 0, i32 0
  ...
  store i64 and (i64 add (i64 ptrtoint (%seg_400640__rodata_type* @seg_400640__rodata to i64), i64 8), i64 4294967295), i64* %3, align 8, !tbaa !1256
  %39 = add i64 %pc, -310
  %40 = add i64 %pc, 18
  %41 = add i64 %7, -32
  ...
  %43 = tail call fastcc %struct.Memory* @ext_400430_puts(%struct.State* nonnull %state2, %struct.Memory* %memory1) #6
  %44 = load i64, i64* %0, align 8
  store i64 and (i64 add (i64 ptrtoint (%seg_400640__rodata_type* @seg_400640__rodata to i64), i64 40), i64 4294967295), i64* %2, align 8, !tbaa !1256
  store i64 and (i64 add (i64 ptrtoint (%seg_400640__rodata_type* @seg_400640__rodata to i64), i64 42), i64 4294967295), i64* %3, align 8, !tbaa !1256
  %45 = add i64 %44, -296
  %46 = add i64 %44, 15
  %47 = load i64, i64* %4, align 8, !tbaa !1256
  %48 = add i64 %47, -8
  %49 = inttoptr i64 %48 to i64*
  store i64 %46, i64* %49
  store i64 %48, i64* %4, align 8, !tbaa !1256
  store i64 %45, i64* %0, align 8, !tbaa !1256
  %50 = tail call fastcc %struct.Memory* @ext_601058_fopen(%struct.State* nonnull %state2, %struct.Memory* %43) #6
  ...
  %62 = and i8 %61, 1
  %63 = xor i8 %62, 1
  store i8 %63, i8* %20, align 1, !tbaa !1271
  store i8 0, i8* %26, align 1, !tbaa !1275
  %64 = icmp eq i64 %57, 0
  %65 = zext i1 %64 to i8
  store i8 %65, i8* %29, align 1, !tbaa !1272
  %66 = lshr i64 %57, 63
  %67 = trunc i64 %66 to i8
  store i8 %67, i8* %32, align 1, !tbaa !1273
  store i8 0, i8* %38, align 1, !tbaa !1274
  %.v = select i1 %64, i64 11, i64 28
  %68 = add i64 %54, %.v
  %69 = add i64 %68, 5
  store i64 %69, i64* %0, align 8
  br i1 %64, label %block_400592, label %block_4005a3

block_4005b2:                                     ; preds = %block_400592, %block_4005a3
  %MEMORY.0 = phi %struct.Memory* [ %82, %block_4005a3 ], [ %90, %block_400592 ]
  %70 = load i64, i64* %5, align 8, !tbaa !1256
  %71 = inttoptr i64 %70 to i64*
  %72 = load i64, i64* %71
  store i64 %72, i64* %5, align 8, !tbaa !1256
  %73 = add i64 %70, 8
  %74 = inttoptr i64 %73 to i64*
  %75 = load i64, i64* %74
  store i64 %75, i64* %0, align 8, !tbaa !1256
  %76 = add i64 %70, 16
  store i64 %76, i64* %4, align 8, !tbaa !1256
  ret %struct.Memory* %MEMORY.0

block_4005a3:                                     ; preds = %block_400566
  store i64 and (i64 add (i64 ptrtoint (%seg_400640__rodata_type* @seg_400640__rodata to i64), i64 85), i64 4294967295), i64* %3, align 8, !tbaa !1256
  %77 = add i64 %68, -371
  %78 = add i64 %68, 10
  %79 = load i64, i64* %4, align 8, !tbaa !1256
  %80 = add i64 %79, -8
  %81 = inttoptr i64 %80 to i64*
  store i64 %78, i64* %81
  store i64 %80, i64* %4, align 8, !tbaa !1256
  store i64 %77, i64* %0, align 8, !tbaa !1256
  %82 = tail call fastcc %struct.Memory* @ext_400430_puts(%struct.State* nonnull %state2, %struct.Memory* %50) #6
...
block_400592:                                     ; preds = %block_400566
  store i64 and (i64 add (i64 ptrtoint (%seg_400640__rodata_type* @seg_400640__rodata to i64), i64 63), i64 4294967295), i64* %3, align 8, !tbaa !1256
  %85 = add i64 %68, -354
  %86 = add i64 %68, 10
  %87 = load i64, i64* %4, align 8, !tbaa !1256
  %88 = add i64 %87, -8
  %89 = inttoptr i64 %88 to i64*
  store i64 %86, i64* %89
  store i64 %88, i64* %4, align 8, !tbaa !1256
  store i64 %85, i64* %0, align 8, !tbaa !1256
  %90 = tail call fastcc %struct.Memory* @ext_400430_puts(%struct.State* nonnull %state2, %struct.Memory* %50) #6
  %91 = load i64, i64* %0, align 8
  store i64 1, i64* %1, align 8, !tbaa !1256
  %92 = add i64 %91, 22
...
; Function Attrs: noinline nounwind
define internal fastcc %struct.Memory* @sub_400460___gmon_start__(%struct.State* dereferenceable(3280) %state2, i64 %pc, %struct.Memory* %memory1) unnamed_addr #3 {
block_400460:
  %0 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 33, i32 0, i32 0
...
; Function Attrs: noinline nounwind
define internal %struct.Memory* @sub_400634__term_proc(%struct.State* nocapture dereferenceable(3280) %state2, i64 %pc, %struct.Memory* returned %memory1) #3 {
block_400634:
  %0 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 33, i32 0, i32 0
...
define dllexport void @main() local_unnamed_addr #4 {
  tail call void asm sideeffect "pushq $0;pushq $$0x400566;jmpq *$1;", "*m,*m,~{dirflag},~{fpsr},~{flags}"(%struct.Memory* (%struct.State*, i64, %struct.Memory*)** nonnull @1, void ()** nonnull @0) #6
  ret void
}

; Function Attrs: noinline nounwind
define internal fastcc %struct.Memory* @ext_400430_puts(%struct.State*, %struct.Memory*) unnamed_addr #5 {
  %3 = tail call %struct.Memory* @__remill_function_call(%struct.State* %0, i64 ptrtoint (i64 (i64)* @puts to i64), %struct.Memory* %1)
  ret %struct.Memory* %3
}

; Function Attrs: noinline nounwind
define internal fastcc %struct.Memory* @ext_601058_fopen(%struct.State*, %struct.Memory*) unnamed_addr #5 {
...
define dllexport void @.term_proc() local_unnamed_addr #4 {
  tail call void asm sideeffect "pushq $0;pushq $$0x400634;jmpq *$1;", "*m,*m,~{dirflag},~{fpsr},~{flags}"(%struct.Memory* (%struct.State*, i64, %struct.Memory*)** nonnull @2, void ()** nonnull @0) #6
  ret void
}
