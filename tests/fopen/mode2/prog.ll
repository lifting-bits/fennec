; ModuleID = 'tests/fopen/mode2/prog.bc'
...
@seg_400640__rodata =  constant %seg_400640__rodata_type <{ [8 x i8] c"\01\00\02\00\00\00\00\00", [32 x i8] c"Calling the fopen() function...\00", [2 x i8] c"r\00", [21 x i8] c"tests/fopen/test.txt\00", [22 x i8] c"fopen() returned NULL\00", [18 x i8] c"fopen() succeeded\00" }>
...
@1 =  constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_400566_main
@2 =  constant %struct.Memory* (%struct.State*, i64, %struct.Memory*)* @sub_400634__term_proc
...
; Function Attrs: noinline nounwind
define  %struct.Memory* @sub_400566_main(%struct.State* dereferenceable(3280) %state2, i64 %pc, %struct.Memory* %memory1) #3 {
block_400566:
  %0 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 33, i32 0, i32 0
  %1 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 1, i32 0, i32 0
...
; Function Attrs: noinline nounwind
define  %struct.Memory* @sub_400634__term_proc(%struct.State* nocapture dereferenceable(3280) %state2, i64 %pc, %struct.Memory* returned %memory1) #3 {
block_400634:
  %0 = getelementptr inbounds %struct.State, %struct.State* %state2, i64 0, i32 6, i32 33, i32 0, i32 0
