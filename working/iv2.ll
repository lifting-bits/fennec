...
block_4006b0:
  ...
  %40 = call %struct.Memory* @sub_400df0_generate_iv(%struct.State* %state2, i64 %36, %struct.Memory* %memory1)
...
block_4006d2:                                     ; preds = %block_4006c8
  ...
  %82 = call %struct.Memory* @sub_400df0_generate_iv(%struct.State* %state2, i64 %77, %struct.Memory* %MEMORY.1)
...
block_4006e9:                                     ; preds = %block_4006d2
  ...
  %163 = tail call %struct.Memory* @sub_400670_random_iv(%struct.State* nonnull %state2, i64 %158, %struct.Memory* undef)
...
declare %struct.Memory* @sub_400df0_generate_iv(%struct.State*, i64, %struct.Memory*)
